...
export default function AppHeader() {
    ...
    return (
        <header
            className={'flex h-[60px] items-center justify-between px-4 sm:h-[64px] md:h-[72px] lg:h-[84px] xl:h-[100px] xl:px-6'}>
            <p className={'text-[20px] font-bold sm:text-[26px] md:text-[36px] lg:text-[48px] xl:text-[60px]'}>SENSE &
                SCIENCE</p>
